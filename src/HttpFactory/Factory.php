 ...
 *
 * PSR-17 requires php 7.1+.
 * Version 1.3 Provides functionality of PSR-17 without the interfaces.
 * Version 2.3 & 3.3 actually implement the PSR-17 interfaces.
 *
 * @psalm-api
 */
class Factory
